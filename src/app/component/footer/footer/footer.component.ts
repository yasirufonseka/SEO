 ...
 newsletterForm: FormGroup;
  ...
  onNewsletterSubmit(): void {
    if (this.newsletterForm.valid) {
      ...
      // You might want to call a service to handle the API call
